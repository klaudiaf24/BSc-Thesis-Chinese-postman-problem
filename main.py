...
if __name__ == "__main__":
    ...
    # graph = osmh.getGraphFromOsm(left=22.0066800, bottom=49.6111700, right=22.0147200, top=49.6143700)  # zarszyn-jacmierz
    ...
    # ch.ChristofidesAlgo(graph)
    hk.HeldKarpAlgo(graph)
